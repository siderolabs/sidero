...
func RegisterConversions(s *runtime.Scheme) error {
	...
	if err := s.AddConversionFunc((*v1alpha2.BMC)(nil), (*BMC)(nil), func(a, b interface{}, scope conversion.Scope) error {
...
func autoConvert_v1alpha1_ServerSpec_To_v1alpha2_ServerSpec(in *ServerSpec, out *v1alpha2.ServerSpec, s conversion.Scope) error {
	...
	if in.BMC != nil {
		...
		*out = new(v1alpha2.BMC)
		if err := Convert_v1alpha1_BMC_To_v1alpha2_BMC(*in, *out, s); err != nil {
			return err
		}
	} else {
		out.BMC = nil
...
func autoConvert_v1alpha2_ServerSpec_To_v1alpha1_ServerSpec(in *v1alpha2.ServerSpec, out *ServerSpec, s conversion.Scope) error {
	...
	if in.BMC != nil {
		in, out := &in.BMC, &out.BMC
		*out = new(BMC)
		if err := Convert_v1alpha2_BMC_To_v1alpha1_BMC(*in, *out, s); err != nil {
			return err
		}
	} else {
		out.BMC = nil
