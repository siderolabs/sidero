...
* [`b340cee`](https://github.com/talos-systems/sidero/commit/b340ceef88921300911c1cae5d347db57ad52f07) fix: shutdown sidero-controller-manager when any component fails
* [`3eb7b28`](https://github.com/talos-systems/sidero/commit/3eb7b2869066f7a1f18e471b5ba5d874cf4a046b) release(v0.3.1): prepare release
* [`3a83663`](https://github.com/talos-systems/sidero/commit/3a836631be8b2428cf0b3006636bc387264203dc) fix: update sidero IPMI user to work properly on idrac
* [`0fc255e`](https://github.com/talos-systems/sidero/commit/0fc255e2f7b6b6317086a4dbcf80bfa6f500f317) fix: update Sfyra to install CAPI v0.3
* [`654a1d0`](https://github.com/talos-systems/sidero/commit/654a1d0c90a504915f223a16fa61224d36a2aa4f) release(v0.3.0): prepare release
* [`ef86bb0`](https://github.com/talos-systems/sidero/commit/ef86bb0eb22e5f17455a87eab5509ddc17d4919c) chore: update to latest stable talos providers
* [`9463b47`](https://github.com/talos-systems/sidero/commit/9463b47ed8840d2693fdb6753dc1b85203608a9b) fix: make sure components of agent environment are of proper arch
* [`20a7622`](https://github.com/talos-systems/sidero/commit/20a76226c82d0fa57b1072afb34ea6ec5ed35a24) feat: update default Talos version to v0.10.3
* [`f2099d9`](https://github.com/talos-systems/sidero/commit/f2099d9bcbfe5020e77e748db787853401386c1f) release(v0.3.0-beta.0): prepare release
* [`864ec57`](https://github.com/talos-systems/sidero/commit/864ec576e49fc9980b6118df979ec8212c3b0179) docs: add doc for using rpi4 as server
* [`a563284`](https://github.com/talos-systems/sidero/commit/a56328431220867049bce04bc2337775c6a5abed) chore: bump dependencies via dependabot
* [`6821dd2`](https://github.com/talos-systems/sidero/commit/6821dd2c0a111ab5a6966d4b73679deb961b3026) feat: update paths of apps
* [`5bfcb9d`](https://github.com/talos-systems/sidero/commit/5bfcb9dff92081f45d4d4173494048a6df7cc9ee) chore: remove parsebool script
* [`e558d18`](https://github.com/talos-systems/sidero/commit/e558d189ebc1c92cb3d6c67b0833507b87a17755) feat: always return BMC IP if found
* [`efd300b`](https://github.com/talos-systems/sidero/commit/efd300b7dbb2655c2abacec196054dc1637b530b) chore: add support for WITH_RACE
* [`2f8ad47`](https://github.com/talos-systems/sidero/commit/2f8ad4731adc8754a4380b6ad98078a60ccb9481) docs: fix duplicate titles in documentation
* [`56ca87c`](https://github.com/talos-systems/sidero/commit/56ca87c09c3de9313586ee2e23b999e175fb91eb) chore: bump dependencies via dependabot
* [`3ab1fad`](https://github.com/talos-systems/sidero/commit/3ab1fadf7fcb7cc50b3efb7752692bf3a6efaa34) fix: make server class qualifiers and selectors optional
* [`72a22a9`](https://github.com/talos-systems/sidero/commit/72a22a90dd179b12940d747ce8649c3162f79fbd) chore: check for dirtiness of the source tree
* [`ceca560`](https://github.com/talos-systems/sidero/commit/ceca5601fbc13a6161ff703b46270cb1513b492d) chore: fix generated CRDs
* [`99c3cd3`](https://github.com/talos-systems/sidero/commit/99c3cd34f04fbc5963aa37043bad1e04ab6445af) release(v0.3.0-alpha.1): prepare release
...
* [`d9a6554`](https://github.com/talos-systems/cluster-api-bootstrap-provider-talos/commit/d9a65541b0cc214074494f08564044624c0f5932) release(v0.2.0): prepare release
* [`b4c09ee`](https://github.com/talos-systems/cluster-api-bootstrap-provider-talos/commit/b4c09eee629bcfeb60a380da3601628192015f9d) release(v0.2.0-beta.0): prepare release
* [`1eb9529`](https://github.com/talos-systems/cluster-api-bootstrap-provider-talos/commit/1eb9529ae4f566d19dce06e1b054ab9ee1059b18) chore: update machinery to latest stable
* [`884c4f0`](https://github.com/talos-systems/cluster-api-bootstrap-provider-talos/commit/884c4f0c35b7eae33607cdf9851cfeb3204bb0d2) fix: remove unused kube-rbac-proxy, protect metrics-addr
...
* [`dc76b9f`](https://github.com/talos-systems/cluster-api-control-plane-provider-talos/commit/dc76b9fc65a015c7f54dcdfd9a29feb37aaad082) release(v0.1.0): prepare release
* [`b787fd8`](https://github.com/talos-systems/cluster-api-control-plane-provider-talos/commit/b787fd8855b897fc29ceadf94c42b7c50e1c9153) chore: update bootstrap provider to stable release
* [`cefb2fc`](https://github.com/talos-systems/cluster-api-control-plane-provider-talos/commit/cefb2fca66d0c41c4c09fa61d952998e7a9a2080) release(v0.1.0-beta.0): prepare release
* [`fb0257d`](https://github.com/talos-systems/cluster-api-control-plane-provider-talos/commit/fb0257d6899dbd73737bbe31aa0676990dc41ad1) feat: audit and remove etcd members if machines no longer exist
* [`182f656`](https://github.com/talos-systems/cluster-api-control-plane-provider-talos/commit/182f6566ba2393def30935dd7b49e44db82e85a2) chore: breakout common functions
* [`f7191a0`](https://github.com/talos-systems/cluster-api-control-plane-provider-talos/commit/f7191a054a9fe7ae9af3eb1d11a93529a4bdb2a0) chore: remove duplicate imports
* [`d7f4618`](https://github.com/talos-systems/cluster-api-control-plane-provider-talos/commit/d7f46186094c72047fbfa81a4a7a4a62ca3061fc) fix: protect metrics-addr by default
* [`7b963e1`](https://github.com/talos-systems/cluster-api-control-plane-provider-talos/commit/7b963e16a079c77531e37104607837cdab88fe9e) release(v0.1.0-alpha.13): prepare release
* [`4bba1c9`](https://github.com/talos-systems/cluster-api-control-plane-provider-talos/commit/4bba1c92a8ddbf9da529d5a7ef5bdfe3d81a7f68) fix: back down resource requests
* [`430fcda`](https://github.com/talos-systems/cluster-api-control-plane-provider-talos/commit/430fcdaad25aeac7da2807b5aad00477c1bc3388) chore: rework build, move to ghcr.io, build for arm64/amd64
...
* [`9d4cd45`](https://github.com/talos-systems/sidero/commit/9d4cd45db99d79ba336320d5303171e46e4921b5) release(v0.3.1): prepare release
* [`3a83663`](https://github.com/talos-systems/sidero/commit/3a836631be8b2428cf0b3006636bc387264203dc) fix: update sidero IPMI user to work properly on idrac
* [`0fc255e`](https://github.com/talos-systems/sidero/commit/0fc255e2f7b6b6317086a4dbcf80bfa6f500f317) fix: update Sfyra to install CAPI v0.3
* [`654a1d0`](https://github.com/talos-systems/sidero/commit/654a1d0c90a504915f223a16fa61224d36a2aa4f) release(v0.3.0): prepare release
* [`ef86bb0`](https://github.com/talos-systems/sidero/commit/ef86bb0eb22e5f17455a87eab5509ddc17d4919c) chore: update to latest stable talos providers
...
## [Sidero 0.3.0](https://github.com/talos-systems/sidero/releases/tag/v0.3.0) (2021-06-21)
